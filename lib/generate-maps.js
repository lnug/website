...
var mapUrl = function(location, pointer) {
    return 'https://api.mapbox.com/v4/mapbox.emerald/pin-m+BED52E(' + location.long + ',' + location.lat + ',17)/' +  + pointer.long + ',' + pointer.lat + ',' + pointer.scale + '/' + pointer.size + '?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6IlhHVkZmaW8ifQ.hAMX5hSW-QnTeRCMAy9A8Q';
};
